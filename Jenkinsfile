            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user45') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user45/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user45') {
                    ...
                    openshift.tag("user45/gateway-canary:latest", "user45/gateway:latest")
